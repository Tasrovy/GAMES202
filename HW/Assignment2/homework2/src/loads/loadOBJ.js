                ...
                .load(name + '.obj', function (object) {
                    object.traverse(function (child) {
                        if (child.isMesh) {
                            ...
                            let attrPrecomputeLT = null;
                            if (objMaterial === 'PRTMaterial' || objMaterial === 'SHPhongMaterial') {
                                attrPrecomputeLT = {name: 'aPrecomputeLT', array: precomputeLT[0]};
                            }
                            ...
                            switch (objMaterial) {
                                ...
                                case 'PRTMaterial':
                                    console.log("begin build PRTMaterial");
                                    material = buildPRTMaterial(
                                        ...
                                        Translation,
                                        Scale,
                                        "./src/shaders/SHPhongShader/SHphongVertex.glsl",
                                        "./src/shaders/SHPhongShader/SHphongFragment.glsl"
                                    );
                                    break;
